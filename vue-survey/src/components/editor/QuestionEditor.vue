    ...
    <div>
        ...
        <div class="grid gap-3 grid-cols-12">
            ...
            <div class="mt-3 col-span-9">
                <label :for="'question_text_' + model.data" class="block text-sm dont-medium text-gray-700">
                    Question Text
                </label>
                ...
                mt-1
                focus:ring-indigo-500focus:border-indigo-500
                block
                w-full
                shadow-sm
                sm:text-sm
        ...
        <div class="mt-3 col-span-9">
            <label :for="'question_description_' + model.id" class="block text-sm dont-medium text-gray-700 ">
                Description
            </label>
            <textarea :name="'question_description_' + model.id" :id="'question_description_' + model.id"
                v-model="model.description" @change="dataChange" class="
            mt-1
            focus:ring-indigo-500
            focus:border-indigo-500
            block
        ...
        <div>
            <div v-if="shouldHaveOptions()" class="mt-2">
                ...
                <div v-for="(option, index) in model.data.options" :key="option.uuid" class="
                flex
                items-center
                mb-1">
