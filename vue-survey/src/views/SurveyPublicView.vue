<template>
    <div class="py-5 px-8">
        ...
        <form action="" v-else class="conteiner mx-auto" @submit.prevent="submitSurvey">
            ...
            <div v-else>
                ...
                <button type="submit"
                    class="inline-flex justify0center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ri">
                    Submit
                </button>
            </div>
