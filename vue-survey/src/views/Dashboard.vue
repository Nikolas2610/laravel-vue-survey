<template>
    <PageComponent title="Dashboard">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700" v-else>
            ...
            <div class="order-3 row-span-2 bg-white shadow-md p-4 lg:order-1 animate-fade-in-down">
                <h3 class="text-2xl font-semibold">Latest Survey</h3>

                <img :src="data.latestSurvey.image_url" class="w-[240px]">
                ...
                <div class="flex justify-between">
                    <RouterLink :to="{ name: 'SurveyView', params: { id: data.latestSurvey.id } }"
            ...
            <div class="order-4 row-span-2 bg-white shadow-md p-3 lg:order-3 animate-fade-in-down"
...
console.log(data.value.latestSurvey);
