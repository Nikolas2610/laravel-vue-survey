    ...
    <PageComponent title="View or Create a survey">
        <template v-slot:header>
            <div class="flex items-center justify-between">
                ...
                <button v-if="route.params.id" type="button" @click="deleteSurvey()"
                    class="py-2 px-3 text-white bg-red-500 rounded-md hoverLbg-red-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 -mt-1 inline-block" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor">
        ...
        <form @submit.prevent="saveSurvey" class="animate-fade-in-down" v-else>
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea name="description" id="description" cols="30" rows="3"
                                placeholder="Describe your survey" autocomplete="survey_description"
                                v-model="model.description" class="shadow-sm focus:ring-indigo-500 docus:border-indigo-500
                            mt-1
                            block
                            w-full
                            sm-text-sm
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" id="status" name="status" v-model="model.status"
                                class="docus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                        </div>
                ...
                <div class="px-4 py-3 bg-white space-y-6 sm:px-6">
                    <div class="flex justify-between items-center text-2xl font-semibold">
                        <h3 class="text-2xl font-semibold dlex items-center justify-between">
                            Questions
                        </h3>
                        <!-- Add new question -->
                        <div>
                            <button type="button" @click="addQuestion()" class="flex
                                items-center
                                text-sm
                                py-1
                                px-4
                ...
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    ...
                    text-white
                    bg-indigo-600
                    hover:bg-indigo-700focus:outline-none
                    focus:ring-2
                    focus:ring-offset-2
